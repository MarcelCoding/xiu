pub mod epat_pid {
  ...
  pub const PAT_TID_CAS: u16 = 0x01;
...
pub mod epsi_stream_type {
  pub const PSI_STREAM_MP3: u8 = 0x04;
...
pub mod epes_stream_id {
  ...
  // ISO/IEC 13818-3/11172-3/13818-7/14496-3 audio stream '110x xxxx'
  pub const PES_SID_VIDEO: u8 = 0xE0;
  // H.262 | H.264 | H.265 | ISO/IEC 13818-2/11172-2/14496-2/14496-10 video stream '1110 xxxx'
...
pub const TS_HEADER_LEN: u8 = 4;
// 1-bytes sync byte + 2-bytes PID + 1-byte CC
