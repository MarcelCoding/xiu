...
impl Mpeg4AacProcessor {
  ...
  pub fn pce_load(&mut self) -> Result<u8, MpegAacError> {
    ...
    element_instance_tag = mpeg4bitvec::mpeg4_bits_copy(&mut pce_bits_vec, &mut self.bits_data, 4)?;
    ...
    comment_field_bytes = mpeg4bitvec::mpeg4_bits_copy(&mut pce_bits_vec, &mut self.bits_data, 8)?;
