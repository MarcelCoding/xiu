...
impl Cache {
  ...
  pub fn save_audio_seq(&mut self, chunk_body: BytesMut, timestamp: u32) -> Result<(), CacheError> {
  ...
  pub fn save_video_seq(&mut self, chunk_body: BytesMut, timestamp: u32) -> Result<(), CacheError> {
