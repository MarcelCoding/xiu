    ...
    match self.current_chunk_info.basic_header.format {
      ...
      ***************************************************/
      2 => {
        ...
        self.current_message_header().timestamp_delta = self.reader.read_u24::<BigEndian>()?;
    ...
    match self.current_chunk_info.basic_header.format {
      ...
      1 => {
        if self.current_message_header().is_extended_timestamp {
          ...
          self.current_message_header().timestamp += self.current_message_header().timestamp_delta;
        }
      }
      2 => {
        if self.current_message_header().is_extended_timestamp {
